...
//Plano texturizado
void CFiguras::plano( GLfloat *normal)  //Funcion creacion plano
{

	GLfloat vertice[8][3] = {
				{0.5 ,0, 0.5},    //Coordenadas Vértice 0 V0
				{-0.5 ,0, 0.5},    //Coordenadas Vértice 1 V1
				{-0.5 ,0, -0.5},    //Coordenadas Vértice 2 V2
				{0.5 ,0, -0.5}    //Coordenadas Vértice 3 V3
